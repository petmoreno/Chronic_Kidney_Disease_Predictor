...
param_grid_v11={'model': [logreg_clf,svc_clf,dectree_clf, rndforest_clf, knn_clf, mlp_clf,ada_clf, nb_clf,xgboost_clf, extratree_clf],
            'data_prep__numeric_pipe__data_missing__strategy':['median'],            
             'data_prep__numeric_pipe__features_select__k_out_features': [1,2,3,4,5,6,7],            
             'data_prep__numeric_pipe__features_select__strategy':['filter_num','wrapper_RFE'] ,        
             'data_prep__category_pipe__features_select__k_out_features': [1,2,3,4,5,6,7],           
...
features_selected=['bgr','bu','sc','sod','hemo','pcv','rc','sg','al','htn','dm','pe']
X_train_feat_selected=X_train[features_selected]
num_feat_selected=['bgr','bu','sc','sod','hemo','pcv','rc']
cat_feat_selected= ['sg','al','htn','dm','pe']
...
ada_clf.fit(df_X_train_featsel,y_train)
...
plt.title('Features Importance with 12 features selected')
...
features_selected_9=['sc','pot','hemo','rc','sg','al','htn','dm','pe']
X_train_feat_selected_9=X_train[features_selected_9]
num_feat_selected_9=['sc','pot','hemo','rc']
cat_feat_selected_9= ['sg','al','htn','dm','pe']
...
ada_clf.fit(X_train_featsel_9,y_train)
ada_clf.feature_importances_
...
plt.title('Features Importance with 9 features selected')
plt.barh(range(len(indices)), importances[indices], color='b', align='center')
plt.yticks(range(len(indices)), [features[i] for i in indices])
plt.xlabel('Gini Importance')
plt.show()